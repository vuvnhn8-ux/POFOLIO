...
export const ui = {
  en: {
    ...
    vibe: {
      kicker: 'Vibe Coding',
      title: 'AI-assisted projects I shipped',
      subtitle:
        'Deployed side projects built with AI-assisted / vibe-coding workflows — turning ideas into live products fast.',
      visit: 'Live demo',
      ...
      items: [
        {
          id: 'vb-1',
          name: 'ReMarket',
          desc: 'Used goods marketplace web platform.',
          tech: ['Full-stack Web', 'Marketplace'],
          url: 'https://remarket.hoangvuvan.xyz/',
          category: 'Web Development',
        },
        {
          id: 'vb-2',
          name: 'HATSCADA',
          desc: 'Real-time factory monitoring SCADA system with PLC integration.',
          tech: ['C#', '.NET', 'PLC', 'Web Monitoring'],
          url: 'https://hatscada.hoangvuvan.xyz/',
          category: 'Industrial / FA',
        },
        {
          id: 'vb-3',
          name: 'TubeMake',
          desc: 'AI-powered automated video creation platform.',
          tech: ['Python', 'AI / Video APIs', 'Automation'],
          url: 'https://tubemake.hoangvuvan.xyz/',
          category: 'AI / Automation',
        },
        {
          id: 'vb-4',
          name: 'AutoCut',
          desc: 'Automated video cutting tool from YouTube links.',
          tech: ['Python', 'Video Processing', 'YouTube API'],
          url: 'https://autocut.hoangvuvan.xyz/',
        ...
        },
        {
          ...
          url: 'https://portfolio.hoangvuvan.xyz/',
          category: 'Web Development',
        },
      ],
    },
  ...
  ja: {
    ...
    vibe: {
      kicker: 'Vibe Coding',
      title: 'AI支援で開発したプロジェクト',
      subtitle:
        'AI支援・バイブコーディングのワークフローで構築し、アイデアからデプロイまで最短で世に送り出した副業プロジェクト群。',
      visit: 'ライブデモ',
      aiAssisted: 'AI支援',
      items: [
        {
          id: 'vb-1',
          name: 'ReMarket',
          desc: '中古品マーケットプレイスのWebプラットフォーム。',
          tech: ['フルスタックWeb', 'マーケットプレイス'],
          url: 'https://remarket.hoangvuvan.xyz/',
          category: 'Web開発',
        },
        {
          id: 'vb-2',
          name: 'HATSCADA',
          desc: 'PLC連携のリアルタイム工場監視SCADAシステム。',
          tech: ['C#', '.NET', 'PLC', 'Web監視'],
          url: 'https://hatscada.hoangvuvan.xyz/',
          category: '産業 / FA',
        },
        {
          id: 'vb-3',
          name: 'TubeMake',
          desc: 'AIによる自動動画作成プラットフォーム。',
          tech: ['Python', 'AI / 動画API', '自動化'],
          url: 'https://tubemake.hoangvuvan.xyz/',
          category: 'AI / 自動化',
        },
        {
          id: 'vb-4',
          name: 'AutoCut',
          desc: 'YouTubeリンクから自動で動画をカットするツール。',
          tech: ['Python', '動画処理', 'YouTube API'],
          url: 'https://autocut.hoangvuvan.xyz/',
          category: '自動化 / メディア',
        },
        {
  ...
  vi: {
    ...
    vibe: {
      kicker: 'Vibe Coding',
      title: 'Dự án thực hiện với AI',
      subtitle:
        'Các dự án phụ đã triển khai bằng quy trình AI-assisted / vibe-coding — biến ý tưởng thành sản phẩm trực tuyến nhanh chóng.',
      visit: 'Demo trực tiếp',
      aiAssisted: 'AI hỗ trợ',
      items: [
        {
          id: 'vb-1',
          name: 'ReMarket',
          desc: 'Nền tảng chợ đồ đã qua sử dụng.',
          tech: ['Full-stack Web', 'Marketplace'],
          url: 'https://remarket.hoangvuvan.xyz/',
        ...
        },
        {
          id: 'vb-2',
          name: 'HATSCADA',
          desc: 'Hệ thống SCADA giám sát nhà máy thời gian thực, tích hợp PLC.',
          tech: ['C#', '.NET', 'PLC', 'Giám sát Web'],
          url: 'https://hatscada.hoangvuvan.xyz/',
          category: 'Công nghiệp / FA',
        },
        {
          id: 'vb-3',
          name: 'TubeMake',
          desc: 'Nền tảng tạo video tự động bằng AI.',
          tech: ['Python', 'AI / Video APIs', 'Tự động hóa'],
          url: 'https://tubemake.hoangvuvan.xyz/',
        ...
        },
        {
          id: 'vb-4',
          name: 'AutoCut',
          desc: 'Công cụ cắt video tự động từ link YouTube.',
          tech: ['Python', 'Xử lý video', 'YouTube API'],
          url: 'https://autocut.hoangvuvan.xyz/',
          category: 'Tự động hóa / Truyền thông',
        },
        {
          id: 'vb-5',
          name: 'Portfolio',
